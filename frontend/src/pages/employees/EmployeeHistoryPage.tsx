...
import type { EmployeeHistory } from '../../types/employee'
...
function ChangesSummary({ h }: { h: EmployeeHistory }) {
...
export function EmployeeHistoryPage() {
  ...
  const { data: history, isLoading } = useEmployeeHistory(id ?? '')
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold">직원 변경이력</h1>
      </div>
